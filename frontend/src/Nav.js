          ...
          <div className="navbar navbar-dark box-shadow">
            <div className="container d-flex justify-content-between">
              <a href="#" className="navbar-brand d-flex align-items-center">
                ...
                <strong>MatchMe!</strong>
              </a>
              {/* <button className="navbar-toggler" type="button" onClick={this.toggleSubNav} aria-controls="navbarHeader" aria-expanded="false" aria-label="Toggle navigation">
